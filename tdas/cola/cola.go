...
type Cola[T any] interface {
	...
	// VerPrimero obtiene el valor del inicio de la cola. Si está vacía, entra en pánico con un mensaje
	// "La cola esta vacia".
	VerPrimero() T
	...
	// Desencolar saca el primer elemento de la cola. Si la cola tiene elementos, se quita el inicio de la misma,
